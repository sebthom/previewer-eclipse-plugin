...
public class Plugin extends AbstractEclipsePlugin {
   ...
   public static IConfigurationElement[] getExtensionConfigurations(final String extensionPointSimpleId) {
      return Platform.getExtensionRegistry().getConfigurationElementsFor(Plugin.PLUGIN_ID, extensionPointSimpleId);
   }
